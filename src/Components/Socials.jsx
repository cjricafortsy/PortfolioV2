    ...
    <div className="flex flex-row justify-between items-center gap-4">
      <a
        ...
        className="text-textcolor md:text-[2.5rem] lg:text-[4rem] xl:text-[1.8rem] 2xl:text-[2.3rem] mt-5 rounded-full lg:p-5 2xl:p-4 p-3 border-2 border-textcolor 
                    shadow-[0px_0px_8px_2px_rgba(22,90,95,0.5),0px_0px_15px_4px_rgba(22,90,95,0.3)] hover:bg-textcolor hover:text-bgcolor duration-500 hover:scale-125 active:scale-50"
      >
        <span>
          <FaFacebookF />
        </span>
