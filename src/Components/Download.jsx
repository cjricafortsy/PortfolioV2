...
function Download() {
  return (
    <a
      ...
      className="text-white md:text-[2rem] xl:text-[1rem] md:py-6 md:px-20 lg:py-[3rem] lg:px-[7rem] mt-5 rounded-full xl:py-4 xl:px-10 py-2 px-5 border-2 border-textcolor 
